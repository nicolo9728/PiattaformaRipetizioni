...
public record ModalitaAccettazioneRappresentation(
    ...
    Type Status,
    string? Causa,
    MetodoPagamento? MetodoPagamentoAccettato,
    MetodoPagamento? MetodoProposto,
...
public static class ConversioniModalita
{
    ...
    extension(IModalitaAccettazione modalita)
    {
        public ModalitaAccettazioneRappresentation ToRappresentation()
            => new ModalitaAccettazioneRappresentation(
                    ...
                    modalita.getStatus() is Accettata a ? a.MetodoAccettato : null,
                    modalita is DocenteDeveAccettare d ? d.MetodoProposto : null,
                    modalita is ConcordareSulPrezzo c ? c.Proposte.ToList() : null);
    }
    ...
    extension(ModalitaAccettazioneRappresentation rappresentation)
    {
        ...
        {
            IModalitaAccettazione modalita = (IModalitaAccettazione)Activator.CreateInstance(rappresentation.Modalita, rappresentation.MetodoProposto != null ? [rappresentation.MetodoProposto] : [])!;
